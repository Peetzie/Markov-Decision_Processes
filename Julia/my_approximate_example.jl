...
# ╔═╡ 9c4730c9-b597-44b2-b5aa-02dd9d850661
using POMDPs, QuickPOMDPs, LocalApproximationValueIteration, LocalFunctionApproximation, GridInterpolations, PlutoUI,Plots; default(fontfamily="Computer Modern", framestyle=:box) # LaTex-style

# ╔═╡ 8e288de4-9853-11ee-2b89-d98cbe36cbaa
import POMDPPolicies: FunctionPolicy

# ╔═╡ caff4420-d2bf-4755-a5af-ba044aac9422
 import POMDPGifs: makegif

# ╔═╡ 11844309-9dfd-4084-9b03-782cfa47d988
import POMDPSimulators: HistoryRecorder

# ╔═╡ a2154667-0f2d-4458-9fd2-95553ec1a814
md"""
...
# ╔═╡ 3a06bdfb-e70d-47aa-9f53-2cb549800e9d
# To avoid defining a state-space we utilize a generative model
mdp = QuickMDP(
...
# ╔═╡ 20433510-1d48-4cb4-aff0-d95e4155ccdc
# Define lengths and positions
begin
	min_position = -1.2
	max_position = 0.5
...
# ╔═╡ 27950f51-8d00-44e0-a347-c50d7273df88
discrete_length = 5

# ╔═╡ 30418f2c-104d-40ce-84ee-d0bcd3439607
...
# ╔═╡ c36e26c4-2bb4-4ec8-858b-27480533496d
@bind xᵢ Slider(-1.5:0.01:0.9, default=-0.1, show_value=true)

# ╔═╡ 0c4d8f6d-9030-4ca6-9a30-a81eab3d6dae
@bind yᵢ Slider(-0.1:0.001:0.1, default=-0.012, show_value=true)

# ╔═╡ 43980346-deec-4a5a-bdf5-6501c725174b
begin
	plot(size=(500,500))
...
# ╔═╡ eaf1f12b-9a63-4c59-b962-81760079f358
begin
...
# ╔═╡ 45384d52-5705-48b1-b695-59ef92beb01e
car_history

# ╔═╡ ee3d97e0-c7fc-49f7-86cd-70cca6fd3ab1
current_state = [car_history[120].s...]

# ╔═╡ 8460b144-58eb-489e-9d0b-5ed5c496a302
begin
	sᵣ = current_state
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "338d225a3936b251dd013c296f4e7f6a4dd85063"
...
git-tree-sha1 = "b1af506558a697ed3431665476c97a1d68771ccf"
